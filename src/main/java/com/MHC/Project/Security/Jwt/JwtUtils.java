package com.MHC.Project.Security.Jwt;
...
public class JwtUtils {
  ...
  public boolean verifyJwtAndSecretKeyFromUser(String jwt, String secretKey) {
      if (validateJwtToken(jwt)) {
          ...
          if (StringUtils.hasText(username)) {
              ...
              if (user != null && user.getSecretKey().equals(secretKey)) {
                  return true; // JWT and Secret Key are valid and matched with User table
              } else {
                  logger.error("Invalid secret key for user: {}", username);
              }
          } else {
